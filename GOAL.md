...
- Course synthesis, reader-checks, term-translator, theorem-use-contracts, paper-source-reader, lecture-source-bridges, lecture-reconstruction-drills, references, quality-rubric, and rubric-coverage pages.
