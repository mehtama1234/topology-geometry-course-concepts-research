...
- `lectures.html`, `lecture-*.html` — lecture explainers with lecture deepening, slow walkthroughs, source checkpoints, and caption nuance.
...
- lecture, lecture-deepening, lecture-walkthrough, caption-nuance, source-lens, source-checkpoint, concept, concept-workup, concept-anchor, theme, theme-lens, subtheme, subtheme-routine, subtheme-bridge, family, method-contract, method-playbook, and math-why depth floors;
