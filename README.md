...
- 82 generated HTML pages in `site/`.
...
- A course-level synthesis page, a reader-checks page, a term-translator page, a paper-source-reader page, a references page with 7 course/paper/text links, a six-test quality rubric, a six-layer rubric coverage audit, a quality audit, and a four-widget interactive math playground.
...
- Required generated pages, including lecture spine, synthesis, concept dependencies, proof moves, formula reader, reader checks, term translator, paper source reader, references, quality rubric, rubric coverage, playground, audits, lectures, concepts, themes, subthemes, and families.
