...
- 1881 lecture deepening words across what-is-happening, why-hard, key-move, and payoff fields
- 1955 slow-walkthrough words across lecture pages, explaining each lecture from object to payoff to reader check
- 2773 lecture reader-test words asking the reader to explain the object, check the allowed move, and protect the conclusion
...
- 10046 concept self-check words showing what a complete concept explanation must include for the object, operation, protected fact, and failure condition
...
- 4608 subtheme answer-guide words showing how to apply the routine on a real page
...
- 3214 method-family answer-guide words showing what a strong method explanation must include
