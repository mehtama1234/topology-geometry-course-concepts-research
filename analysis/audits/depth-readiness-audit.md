...
- 2734 lecture reader-test words asking the reader to explain the object, check the allowed move, and protect the conclusion
- 3536 lecture answer-guide words showing what a strong self-check answer must contain
...
- 2374 source-faithfulness words separating caption support, course inference, and source caveats on lecture pages and source audit cards
...
- 8376 concept self-check words showing what a strong answer must include for the object, operation, protected fact, and failure condition
...
- 2566 theme answer-guide words showing how to carry a theme across lectures
- 10 expanded subtheme pages with essay, first-principles, and course-role sections
- 1431 subtheme routine words across look-for, ask, use, and mistake fields
- 1272 subtheme bridge words across course-moment, thinking-shift, and reader-test fields
- 4307 subtheme answer-guide words showing how to apply the routine on a real page
...
- 905 method-playbook words across setup, move, payoff, failure, and reader-test fields
- 2810 method-family answer-guide words showing what a strong method explanation must include
...
- repair-clinic.html with 8 flawed explanations repaired into first-principles versions and 1651 repair-clinic words
- oral-exam.html with 7 final readiness prompts and 1570 oral-exam words
- change-ledger.html with 10 change-versus-survival cases and 2018 change-ledger words
- assumption-ledger.html with 10 hidden-assumption cases and 1835 assumption-ledger words
- counterexample-gallery.html with 10 failure scenes and 1865 counterexample words
- weak-claim-repairs.html with 10 shallow claims repaired into first-principles explanations and 1668 repair words
...
- paper-family-ledger.html with 7 paper/source family contracts and 1953 paper-family words
