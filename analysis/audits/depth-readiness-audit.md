...
- 2731 lecture answer-guide words showing what a strong self-check answer must contain
...
- 2520 source-faithfulness words separating caption support, course inference, and source caveats on lecture pages and source audit cards
...
- 8072 concept self-check words showing what a strong answer must include for the object, operation, protected fact, and failure condition
...
- 2304 theme answer-guide words showing how to carry a theme across lectures
...
- 3458 subtheme answer-guide words showing how to apply the routine on a real page
...
- 2285 method-family answer-guide words showing what a strong method explanation must include
...
- paper-family-ledger.html with 7 paper/source family contracts and 1263 paper-family words
