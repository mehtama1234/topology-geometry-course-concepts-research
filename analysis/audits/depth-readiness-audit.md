...
- 2109 source-faithfulness words separating caption support, course inference, and source caveats on lecture pages and source audit cards
...
- 3584 subtheme answer-guide words showing how to apply the routine on a real page
- 5 expanded method-family pages with essay, human-problem, how-it-works, examples, and failure-mode sections
- 727 method-contract words across input, action, protected-evidence, output, and failure-test fields
- 711 method-playbook words across setup, move, payoff, failure, and reader-test fields
- 2258 method-family answer-guide words showing what a strong method explanation must include
...
- repair-clinic.html with 8 flawed explanations repaired into first-principles versions and 1136 repair-clinic words
- oral-exam.html with 7 final readiness prompts and 875 oral-exam words
...
- paper-family-ledger.html with 7 paper/source family contracts and 1005 paper-family words
