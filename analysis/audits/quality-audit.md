...
- **Hand-written concepts, themes, subthemes, and method families** (met): 24 concepts, 6 themes, 10 subthemes, and 5 method families all have essay sections plus validated first-principles depth fields; concept pages also include anchor examples and work-from-scratch blocks.
