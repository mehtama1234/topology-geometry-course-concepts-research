...
SOURCE_READERS = [
    ...
    },
    {
        ...
        "first_principles_bridge": "A source-backed companion needs more than mathematical background. It needs a stable course identity so the generated lecture sequence stays tied to the actual teaching source rather than drifting into a standard list of topology topics.",
        "how_to_read": "Use the mirror to verify the course as a series, then return to the lecture pages for the mathematical reading. It is a provenance source, so it can answer who, what course, and what sequence. It cannot answer why a particular proof works or what exact mathematical claim a lecture makes.",
        ...
        "reader_question": "What does this source verify about the course identity, and what mathematical claim still needs evidence from captions, visible demonstrations, or a real background reference?",
    ...
    },
    {
        ...
        "reader_question": "Which formal construction is just a careful version of a route, gluing rule, deformation, or preserved count already seen in the course, and what would be lost if that construction were named before its job was explained?",
    ...
    },
    {
        ...
        "reader_question": "What coincidence was removed, what sign rule became available, why does the signed total survive the allowed move, and which part is formal support rather than lecture evidence?",
...
PAPER_FAMILY_LEDGER_ROWS = [
    ...
    },
    {
        ...
        "reader_test": "Can the reader say what this source verifies, what it leaves unverified, and what kind of mathematical claim must still come from the videos or supporting references?",
        "concepts": ["topology-vs-geometry", "deformation", "manifold"],
    },
    {
        "reference": "poincare-analysis-situs",
    ...
    },
    {
        ...
        "protected_idea": "The protected idea is that formal constructions organize the same surviving shape information that the course first shows with pictures: routes that cannot move away, gluing rules that define travel, and counts that survive legal deformation.",
        ...
        "reader_test": "Can the reader translate a formal construction into the course question: what moves, what stays, what evidence survives, and what conclusion follows?",
        "concepts": ["quotient-space", "product-space", "invariant"],
    },
    {
        "reference": "milnor-differentiable-viewpoint",
    ...
    },
    {
        ...
        "reader_test": "Can the reader name the coincidence removed, the sign rule made available, the legal move that preserves the signed total, and the stronger formal claim the lecture page does not need?",
        "concepts": ["generic-position", "intersection-number", "boundary-orientation"],
    },
]
