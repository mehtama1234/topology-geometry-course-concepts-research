...
LECTURE_ESSAYS = {
    ...
    13: [
        ...
        "This lecture also explains why the earlier examples were worth carrying. Euler characteristic learned from surface decomposition now appears on the same line as indices learned from vector fields. The equality is a translation between two kinds of bookkeeping: one made from pieces of a surface, the other made from local turning of arrows. The theorem matters because those accounts must agree when the hypotheses are met.",
    ],
    14: [
    ...
    15: [
        ...
        "The mathematical center of the course is the relation between permission and consequence. Once a problem states what changes are legal, the answer is often no longer a matter of guessing the right picture. The object may carry a side reversal, an endpoint order, a signed count, a fixed point, or an index total that cannot be escaped. The final lecture asks the reader to recognize that same structure even when the surface details change.",
    ],
}
