...
CONCEPT_ESSAYS = {
    ...
    "poincare-hopf": [
        ...
        "The first-principles structure has four parts. First, choose the surface. Second, clean the vector field so its failures are isolated. Third, assign each failure a local index by reading how nearby arrows turn. Fourth, add those local numbers and compare the sum with Euler characteristic. The theorem is powerful because it makes that final comparison unavoidable.",
...
FAMILY_ESSAYS = {
    "deformation-family": [
        ...
        "The mathematical principle is plain: if every allowed step preserves the relevant fact, then the final easy picture can speak for the original hard picture. The danger is equally plain: one illegal step can make the final picture irrelevant. Deformation is powerful because its freedom is disciplined.",
    ],
    "counting-family": [
