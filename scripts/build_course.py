...
SUBTHEME_ESSAYS = {
    ...
    "turning-and-curvature": [
        ...
        "This subtheme connects geometry to topology without erasing either side. The local measurement matters because its sum is not arbitrary. Gauss-Bonnet-style reasoning says total curvature and turning can answer to surface topology. Vector-field index says arrow turning around defects can add to Euler characteristic. The same pattern appears with different local quantities.",
    ...
    "singular-moments": [
        ...
        "The reader's check is to compare before and after. What local events appeared or disappeared? Did they come in a pair? Did their signs cancel? Did a defect split without changing total index? The singular instant matters because it explains why ordinary pictures on either side remain part of one legal story.",
    ],
    "models-not-labels": [
...
SUBTHEME_BRIDGES = {
    ...
    "turning-and-curvature": {
        ...
        "thinking_shift": "The reader stops treating a local bend or turn as isolated and asks what total it contributes to. A local measurement matters because the completed surface or boundary makes all local contributions answer together, so the page has to name the whole object collecting them.",
...
CONCEPT_ESSAYS = {
    ...
    "invariant": [
        ...
        "The power of an invariant is often negative: it proves that something cannot happen. If two pictures have different protected counts, no legal deformation connects them. If a desired crossing-free drawing would require a count to change, the drawing is impossible. This is why invariants are not vocabulary decorations in the course. Without an invariant, deformation can feel persuasive but leave no evidence that the answer survived.",
        "A good invariant is matched to the allowed moves. One-sidedness is useful for Mobius-strip behavior because ordinary bending does not create a second side. Euler characteristic is useful because changes in a cell division cancel in the alternating count. A signed intersection count is useful because opposite pairs cancel when the picture changes legally. The protected fact must be chosen for the exact motion being allowed.",
...
LECTURE_ESSAYS = {
    ...
    12: [
        ...
        "This is where the earlier surface bookkeeping becomes visibly necessary. Euler characteristic was not just a cell-counting curiosity. It becomes the number that controls the total defect of a vector field. The lecture therefore connects three layers of the course: surfaces can be decomposed and counted, vector fields can fail locally, and topology can force the total of those failures. Poincare-Hopf matters because it makes motion answer to shape.",
...
LECTURE_SOURCE_LENS = {
    ...
    15: [
        ...
        "The source lens is to follow the conversions. Paper strips become global surface evidence. Deformations protect questions. Intersections become signed counts. Fixed points and vector fields turn those counts into existence and motion statements. The final review matters because it shows that the same reasoning pattern has been reused, not replaced, across the course.",
    ],
}
