...
PAPER_FAMILY_LEDGER_ROWS = [
    ...
    },
    {
        ...
        "reader_test": "Can the reader name the field, list the defects being counted, say what surface number controls the total, and state what stronger dynamics claim is not supported? A correct answer should not pretend that an index theorem solves the motion path.",
        "concepts": ["vector-field-index", "equilibrium", "poincare-hopf"],
    },
    {
        "reference": "hatcher-algebraic-topology",
...
THEOREM_USE_CONTRACTS = [
    {
        ...
        "allowed_move": "The allowed move is to refine, redraw, or replace the cell division while keeping the same completed surface, the same boundary conditions, and the same gluing information.",
        "protected_evidence": "The protected evidence is the alternating count. Internal refinements change separate counts, but the artificial vertex-edge-face changes cancel in the final account.",
    ...
    },
    {
        ...
        "object_needed": "The object is the same curve, surface, map, or field after a small legal nudge that removes special alignments without changing the question or the carrier space.",
        ...
        "protected_evidence": "The protected evidence is the stable pattern that remains after accidents are removed: clean meetings, isolated defects, or ordinary local behavior that the proof can inspect one event at a time.",
        ...
        "breaks_if": "It breaks if the nudge changes the object, crosses a forbidden boundary, removes a required contact, or silently changes the protected count that the later argument needs.",
        "everyday_test": "Can the reader name the coincidence being removed, say what count or sign becomes readable afterward, and explain why the small move leaves the original question unchanged?",
        "concepts": ["generic-position", "intersection-number", "vector-field-index"],
    },
    {
        "name": "Signed intersection number",
        "use_when": "Use it when two oriented objects meet cleanly and the question is whether legal motion can remove all meetings without changing the surrounding problem.",
        "object_needed": "The objects are the meeting subspaces, the surrounding space they live in, and an orientation rule that gives each clean meeting a plus or minus sign.",
        "allowed_move": "The allowed move is a deformation that keeps the objects in the right surrounding space and inspects births or deaths of meeting pairs as local events.",
        "protected_evidence": "The protected evidence is the signed total. Opposite-sign pairs can appear or disappear without changing the total because their contributions cancel under the shared orientation rule.",
        "conclusion_it_can_force": "A nonzero signed total can force some meeting to remain under legal motion. It can turn a visual crossing question into durable arithmetic, but it does not locate every meeting.",
        ...
        "everyday_test": "Can the reader explain where each sign comes from, what legal motion could create a newly born pair, and why that pair contributes no net evidence?",
        "concepts": ["intersection-number", "boundary-orientation", "generic-position"],
    },
    {
        "name": "Graph and diagonal fixed-point test",
        "use_when": "Use it when a rule sends inputs to outputs in the same setting and the question is whether some input is sent back to itself.",
        "object_needed": "The object is a rule from a space back into that same space, its graph in input-output space, and the diagonal that records equality between input and output.",
        "allowed_move": "The allowed move is to translate the rule into its graph without changing the domain, target, or meaning of equality between input and output.",
        "protected_evidence": "The protected evidence is the exact equivalence between graph meeting diagonal and self-agreement of the original rule, point by point in the same space.",
        "conclusion_it_can_force": "It can turn a fixed-point question into an intersection question. By itself it identifies what a fixed point means; extra shape or continuity reasoning is needed to force existence.",
        "breaks_if": "It breaks if the graph is drawn for the wrong rule, if the rule does not map the space back into itself, if the diagonal belongs to a different space, or if the domain has been changed.",
    ...
    },
    {
        ...
        "object_needed": "The object is the closed filled ball, including its interior and boundary, plus a continuous self-map that never sends points outside the ball.",
        "allowed_move": "The allowed move is to use continuity and the filled shape's boundary constraint to rule out a total escape from self-agreement for every point at once.",
        "protected_evidence": "The protected evidence is the no-escape structure of a closed filled ball under a continuous self-map that stays inside the same ball.",
        "conclusion_it_can_force": "It can force existence of at least one fixed point. It does not compute the point, say it is unique, or describe the path by which points move.",
        "breaks_if": "It breaks if the space is not the right closed filled shape, if the boundary has been removed, if the rule is not continuous, or if the rule sends points outside the domain.",
        "everyday_test": "Can the reader state the space, the rule, the inside-itself condition, the no-jump condition, and why the theorem proves existence rather than location?",
    ...
    },
    {
        ...
        "allowed_move": "The allowed move is to clean or redraw the nearby arrow pattern while keeping the defect isolated and the surrounding loop meaningful for the same local failure.",
        "protected_evidence": "The protected evidence is the signed turning of arrows during one trip around that one isolated defect, read from the surrounding loop before other defects enter.",
        "conclusion_it_can_force": "It can turn a local failure of motion into countable evidence. It does not count how many equilibria exist, and it becomes global evidence only after all local indices are included.",
        "breaks_if": "It breaks if the defect is not isolated, if another defect lies inside the loop, if the arrows are not tangent to the claimed surface, or if the surface carrying the arrows has been modeled incorrectly.",
        "everyday_test": "Can the reader walk around the defect in words, say how the arrows turn during one full trip, and explain why no other defect is inside the loop?",
    ...
    },
    {
        ...
        "object_needed": "The object is the entire surface carrying the vector field, plus the complete list of isolated defects and their indices on that same surface.",
        "allowed_move": "The allowed move is to add all local indices and compare that total with the Euler characteristic of the same surface, without dropping boundary or defect data.",
        "protected_evidence": "The protected evidence is the equality between the complete total local index and the Euler characteristic of that same surface, not one favorite defect.",
        "conclusion_it_can_force": "It can force defects, forbid a nowhere-zero field on some surfaces, or show that local motion failures answer to whole-surface structure. It does not solve the differential equation or trace trajectories.",
        "breaks_if": "It breaks if one defect is omitted, if the field is not on the claimed surface, if boundary behavior is ignored, if defects are not isolated, or if one equilibrium is treated as the whole theorem.",
        "everyday_test": "Can the reader name the surface, list every defect, add their signed indices, and say which Euler characteristic the total must match before claiming the theorem applies?",
        "concepts": ["poincare-hopf", "vector-field-index", "euler-characteristic"],
    },
    {
        ...
        "object_needed": "The object is the space of all allowed states, with enough coordinates to describe one complete state and with forbidden states removed before the theorem is used.",
        "allowed_move": "The allowed move is to translate physical motion into paths through the state space without adding false freedoms, omitting real freedoms, or removing real barriers.",
        "protected_evidence": "The protected evidence is the shape of possible states: connected regions, holes, walls, fixed points, or total index constraints inside the honest model after forbidden states are removed.",
        ...
        "everyday_test": "Can the reader describe one complete state, name the forbidden states, and explain how a path in the model represents real motion without passing through an impossible state?",
        "concepts": ["configuration-space", "product-space", "fixed-points"],
    },
]
...
def build_lecture_reconstruction_drills(lectures, lecture_source_bridges):
    ...
    for lecture in lectures:
        ...
        repair_join = varied((number, "drill-repair-join"), [
            ...
            f"The better answer should recover the lecture's working order and end at this later job: {spine['why_later']}",
