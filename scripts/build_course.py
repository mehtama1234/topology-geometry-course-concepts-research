...
TRANSFER_LAB_CASES = [
    {
        ...
        "reader_task": "Explain whether the band can be freed without cutting it, name the exact move that would be illegal, and say which relationship survives every legal stretch.",
    ...
    },
    {
        ...
        "wrong_transfer": "A weak answer says both paths are just lines between the same gates. That ignores the obstacle that makes the state space different and treats endpoint agreement as enough by itself.",
    ...
    },
    {
        ...
        "object": "The object is the arrow field near an isolated calm point, together with a small loop around that point. The calm point is not just a dot; it is a place where the arrow field fails, and the surrounding arrows are the evidence.",
        ...
        "protected_fact": "The protected fact is the total turning of the arrows during one walk around the loop. That turning can survive redrawings even when individual arrows are sketched differently.",
        ...
        "reader_task": "Walk around the calm point in words, say what has to stay isolated before an index-like count is meaningful, and state what this local count does not predict.",
        "concepts": ["vector-field-index", "equilibrium", "generic-position"],
    },
    {
        ...
        "object": "The object is the space of all allowed sofa positions and rotations, not just one drawing of the hallway. One point in that space must record enough information to know where the sofa is and how it is turned.",
        ...
        "reader_task": "Name what one point of the state space represents, what would count as a forbidden state, and how a path in that space translates back into real sofa motion.",
    ...
    },
    {
        ...
        "reader_task": "State the domain, the rule, and the exact conclusion without pretending to locate the fixed point or claiming that every bit of coffee returns.",
        "concepts": ["brouwer-fixed-point", "fixed-points", "topology-vs-geometry"],
    },
    {
        ...
        "reader_task": "Say which points become the same point, what boundary claim changes after the identification, and which feature of the flat drawing should no longer be read literally.",
        "concepts": ["quotient-space", "boundary-orientation", "manifold"],
    },
    {
        ...
        "reader_task": "Identify one visible count that is not protected, one whole-surface fact that is protected, and the illegal change that would stop the protected fact from applying.",
    ...
    },
    {
        ...
        "allowed_move": "The allowed move is a continuous path through allowed joint choices, with no intermediate pose entering the blocked zone. The arm may move gradually through joint space, but the path cannot pass through a forbidden pose just because the drawing on the table looks convenient.",
        ...
        "reader_task": "Describe one complete state of the arm, explain what removed states do to the route question, and say what conclusion would overclaim beyond the state-space model.",
        "concepts": ["configuration-space", "product-space", "fixed-points"],
    },
]
...
CHANGE_LEDGER_ROWS = [
    ...
    },
    {
        ...
        "why_matters": "Euler characteristic turns a surface into a stable whole-surface number. It lets the course compare surfaces without being fooled by a busier or cleaner cell drawing.",
        ...
        "reader_test": "Can the reader name the surface, explain which cell numbers changed under the redraw, and show why the alternating count is still about that same surface?",
    ...
    },
    {
        ...
        "protected_fact": "The protected fact is the identification rule: which edges match, which directions match, and which apparent boundary points become one point of the completed surface.",
        ...
        "reader_test": "Can the reader pick two drawn points, decide whether the rule makes them the same point, and say which flat-picture feature should no longer be trusted literally?",
    ...
    },
    {
        ...
        "reader_test": "Can the reader identify the space, the rule, the diagonal of self-agreement, the same-space condition, and the exact conclusion that is earned?",
        "concepts": ["fixed-points", "brouwer-fixed-point", "intersection-number"],
    },
    {
        ...
        "why_matters": "Index turns a local failure of arrows into countable evidence. Once each isolated defect has such a count, the course can add local facts instead of relying on a hand-waved story about how the arrows seem to move.",
    ...
    },
    {
        ...
        "protected_fact": "The protected fact is the total signed index of all defects. Under the theorem's assumptions that total must match the Euler characteristic of the surface carrying the field.",
        "why_matters": "Poincare-Hopf ties local failures to a whole-surface number. It says the defects cannot be discussed as isolated anecdotes once they all live on the same surface.",
        ...
        "reader_test": "Can the reader name the surface, list the defects being counted, state both sides of the equality, and explain why one missing defect breaks the account?",
        "concepts": ["poincare-hopf", "vector-field-index", "euler-characteristic"],
    },
    {
        ...
        "legal_change": "A physical motion becomes a path only if every intermediate state is allowed. Collisions, blocked positions, and impossible choices must be removed before the route question is asked.",
        "protected_fact": "The protected fact is the shape of the allowed state space: walls, holes, separated regions, narrow passages, and possible paths between start and target states.",
        ...
        "false_move": "The false move is to draw only the machine in physical space and assume the drawing records every freedom, obstacle, and continuous choice needed for the route problem.",
        "reader_test": "Can the reader say what one state-space point records, which physical situations were removed, and how a path in the space becomes a real gradual motion?",
        "concepts": ["configuration-space", "product-space", "deformation"],
    },
    {
        ...
        "legal_change": "The sentence may be strengthened, weakened, or moved only according to the evidence actually available and the caveats around that evidence. A caption-backed claim, a course-arc inference, and a background-source claim should not be treated as the same kind of support.",
        ...
        "why_matters": "Source discipline keeps plain explanation honest. The wording should help a reader understand the mathematics without becoming louder than the evidence, especially when captions are auto-generated or missing.",
        ...
        "reader_test": "Can the reader quote the exact claim, name the evidence type behind it, state the strongest version the evidence supports, and rewrite the sentence when the evidence is weaker?",
        "concepts": ["topology-vs-geometry", "invariant", "poincare-hopf"],
    },
]
...
ASSUMPTION_LEDGER_ROWS = [
    {
        ...
        "claim": "A simplified picture answers the original question because the simplification kept the same object for the purpose of that question.",
        ...
        "course_place": "This assumption runs through knot, route, quotient, and surface arguments where a messy drawing is replaced by a cleaner one. It is the check that turns redrawing into reasoning.",
        "concepts": ["deformation", "quotient-space", "knots-and-links"],
    },
    {
        "title": "Boundary data is fixed",
        "claim": "A crossing, route obstruction, or impossibility survives simplification because the boundary information that defines the problem stayed fixed.",
        ...
        "why_needed": "Many obstructions live in the boundary data. If the boundary can be rearranged, an apparent solution may only prove that a different boundary problem is easier.",
        "plain_check": "Can the reader mark the data that live on the edge, say which of them must stay put, and explain why moving one of them would change the question?",
    ...
    },
    {
        ...
        "claim": "A rule, path, deformation, or motion cannot jump past the obstruction because every intermediate state must still be accounted for.",
        ...
        "plain_check": "Can the reader describe what the intermediate states are, where they live, and why the motion cannot skip from before to after in one step?",
    ...
    },
    {
        ...
        "claim": "A signed count of intersections can be used as evidence because the meetings have been prepared so they can be inspected one at a time.",
        ...
        "plain_check": "Can the reader isolate one meeting, draw a small circle or window around it, assign its sign, and explain what nearby legal motion would do to that single event?",
        ...
        "course_place": "This assumption sits behind generic position, intersection number, and clean-meeting source families whenever crossings are counted. It explains why the course often cleans a picture before counting it.",
        "concepts": ["generic-position", "intersection-number", "boundary-orientation"],
    },
    {
        "title": "Signs have a shared direction rule",
        "claim": "Plus and minus contributions can be added and trusted because they use one shared direction rule across the object.",
        ...
        "why_needed": "Signed arithmetic only works when the signs belong to the same rulebook. Without a shared direction rule, the symbols may look precise while adding unrelated local choices.",
        "plain_check": "Can the reader say where the direction convention comes from, carry it to the next meeting or defect, and notice whether the object blocks such a shared choice?",
        ...
        "course_place": "This assumption supports boundary orientation, intersection number, turning counts, and index comparisons across one shared object. It is what makes plus and minus evidence comparable rather than decorative.",
        "concepts": ["boundary-orientation", "intersection-number", "vector-field-index"],
    },
    {
        "title": "All defects are included",
        "claim": "A total index or Poincare-Hopf comparison constrains the field because all local defects belong to one complete account.",
        ...
        "plain_check": "Can the reader name the surface, name the field, list every defect being counted, and state the surface number the total is compared with?",
    ...
    },
    {
        ...
        "claim": "A configuration-space path represents a real physical motion because each point records one complete allowed state.",
        ...
        "plain_check": "Can the reader say what one point records, what has been removed, and how a continuous path through such points translates back into the original moving system?",
        ...
        "course_place": "This assumption supports configuration-space and product-space modeling in the later motion examples. It is the check that keeps a state-space drawing tied to real possible motion.",
        "concepts": ["configuration-space", "product-space", "deformation"],
    },
    {
        "title": "The rule maps the space to itself",
        "claim": "A fixed-point theorem or graph-and-diagonal argument can be used because the rule stays inside one space.",
        ...
        "plain_check": "Can the reader name the space, name the rule, test a typical output, and explain why every output is still an allowed point of that same space?",
        ...
        "course_place": "This assumption supports fixed-point pages, Brouwer contracts, and graph-and-diagonal explanations where self-agreement is forced. It is the check before any existence claim is allowed.",
        "concepts": ["fixed-points", "brouwer-fixed-point", "configuration-space"],
    },
    {
        "title": "A cell count describes the same surface",
        "claim": "Euler characteristic survives changing the cell decomposition because the new cell account still describes the same surface.",
        ...
        "why_needed": "Euler characteristic is a whole-surface ledger, not a reward for one drawing. The count survives because artificial internal bookkeeping changes cancel while the surface remains the same.",
        ...
        "course_place": "This assumption supports triangulation, Euler characteristic, surface classification, and Poincare-Hopf comparisons across the same surface. It keeps arithmetic attached to the object rather than to a convenient sketch.",
        "concepts": ["triangulation", "euler-characteristic", "manifold"],
    },
    {
        "title": "The source supports exactly this claim",
        "claim": "A paper, textbook, caption, or course record justifies a sentence in the companion because the evidence supports that exact sentence.",
        ...
        "plain_check": "Can the reader name the exact sentence, the source evidence behind it, the kind of support that evidence provides, and the stronger sentence that should remain unsaid?",
        ...
        "course_place": "This assumption supports source readers, source nuance repairs, paper-family ledgers, and lecture source-faithfulness audits. It keeps the companion's confidence matched to the evidence trail.",
        "concepts": ["topology-vs-geometry", "invariant", "poincare-hopf"],
    },
]
