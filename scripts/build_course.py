...
THEME_ESSAYS = {
    ...
    "count-what-survives": [
        ...
        "The theme becomes richer as the course progresses. Euler characteristic is the first major stable count for surfaces. Intersection number turns meetings into signed evidence. Poincare-Hopf turns vector-field defects into a total controlled by the surface. Parity is the simplest version, keeping only evenness or oddness when pairs are the only allowed change. These are not separate tricks; they are one habit applied to different objects.",
