...
MATH_WHY = {
    ...
    "reader_path": "This course should not be learned as a vocabulary list. The path is: first see a physical surprise, then name the object, then name the legal motion, then ask what fact survives that motion, then build a count or obstruction, then state exactly what kind of conclusion follows. The companion links lectures, concepts, themes, subthemes, and method families in both directions so that every term points back to the work it performs.",
}
