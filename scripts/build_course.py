...
def build_concept_self_check(concept):
    ...
    operation_intro = varied((cid, "concept-operation-intro"), [
        ...
        f"Ask what the reader is allowed to do with the object when using {title}.",
    ...
    protected_intro = varied((cid, "concept-protected-intro"), [
        ...
        "Put the lasting evidence between the example and the conclusion.",
    ])
    failure_intro = varied((cid, "concept-failure-intro"), [
        ...
        "Name the shortcut that would make the sentence stronger than the evidence.",
