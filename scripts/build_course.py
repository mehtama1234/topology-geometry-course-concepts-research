...
THEOREM_USE_CONTRACTS = [
    ...
    },
    {
        ...
        "allowed_move": "The allowed move is to translate the rule into its graph without changing the domain, target, or meaning of equality.",
        "protected_evidence": "The protected evidence is the exact equivalence between graph meeting diagonal and self-agreement of the original rule.",
    ...
    },
    {
        ...
        "protected_evidence": "The protected evidence is the signed turning of arrows during one trip around that one isolated defect.",
    ...
    },
    {
        ...
        "protected_evidence": "The protected evidence is the equality between the complete total local index and the Euler characteristic of that same surface.",
