...
def build_lecture_answer_guide(lecture, spine_row):
    ...
    conclusion_openings = {
        1: "The fact to protect is the side reversal after a full trip:",
        2: "The fact to protect is the boundary order that no legal redraw can escape:",
        3: "The fact to protect is the construction rule inside the finished space:",
        4: "The fact to protect is the gluing instruction carried by the square:",
        5: "The fact to protect is the durable surface data:",
        6: "The fact to protect is the cleaned pattern of meetings:",
        7: "The fact to protect is the no-jump passage through balance:",
        8: "The fact to protect is the signed total after pair changes:",
        9: "The fact to protect is the meeting between graph and diagonal:",
        10: "The fact to protect is the closed ball's lack of a total escape plan:",
        11: "The fact to protect is the local arrow pattern around a vanishing point:",
        12: "The fact to protect is the total index demanded by the surface:",
        13: "The fact to protect is the equality between total index and Euler characteristic:",
        14: "The fact to protect is the state-space constraint on the physical system:",
        15: "The fact to protect is the course-wide pattern of object, move, evidence, and consequence:",
    }
    return {
...
def build_concept_self_check(concept):
    ...
    protected_prompt = varied((cid, "protected-check-prompt"), [
        ...
        f"Separate the surviving fact from the drawing noise: {protected} Then connect the survival to the course principle: {anchor['principle']} {protected_close}",
        ...
        f"Name the part of the setup that legal change cannot remove: {protected} Then relate it to the course principle: {anchor['principle']} {protected_close}",
    ...
    object_intro = varied((cid, "concept-object-intro"), [
        ...
        f"Treat the surface, route, field, rule, count, or state space as the starting evidence.",
    ...
    operation_intro = varied((cid, "concept-operation-intro"), [
        ...
        f"Describe how the hard picture is turned into usable evidence.",
    ...
    protected_intro = varied((cid, "concept-protected-intro"), [
        ...
        "Say what still speaks for the original problem after the setup has been simplified.",
    ...
    failure_intro = varied((cid, "concept-failure-intro"), [
        ...
        "Use the false case to expose the condition the real argument needs.",
