...
COUNTEREXAMPLE_GALLERY_ROWS = [
    {
        ...
        "tempting_claim": "The strip can be flattened into an ordinary band, so the two strip pictures should answer the same question.",
        ...
        "repair": "State the gluing rule before drawing. Then any simplification has to preserve that rule, not only the visible rectangular shape. A repaired sentence should say that two drawings may be compared only after the same identifications and full-trip side behavior are still present.",
        "concepts": ["quotient-space", "topology-vs-geometry", "boundary-orientation"],
    },
    {
        "title": "Moving an endpoint removes the obstruction",
        "tempting_claim": "Two routes can be uncrossed by sliding one endpoint around the boundary, so the crossing was never forced.",
        ...
        "repair": "Mark the endpoints and keep them fixed while simplifying the interior. Then test whether a crossing remains forced under that restricted motion. A repaired explanation should say exactly which boundary points are fixed and which interior motion is still allowed.",
        "concepts": ["boundary-orientation", "graph-planarity", "deformation"],
    },
    {
        "title": "Counting raw crossings overreads the picture",
        "tempting_claim": "The drawing has two crossings, so the mathematical evidence should be the visible number two before any deformation or sign rule is checked.",
    ...
    },
    {
        ...
        "tempting_claim": "The plus crossings and minus crossings cancel, so the signed total proves the same conclusion even if the sign rule has not been justified.",
        ...
        "repair": "Name the orientation source first. If the object cannot support the required direction rule, do not use signed cancellation as evidence. A repaired sentence should say where the sign convention comes from and what local event it lets the proof count.",
        "concepts": ["boundary-orientation", "intersection-number", "vector-field-index"],
    },
    {
        "title": "Applying Brouwer outside its contract",
        "tempting_claim": "A continuous rule has a fixed point because Brouwer says continuous maps have fixed points, regardless of the space, boundary, or target.",
    ...
    },
    {
        ...
        "tempting_claim": "The visible equilibria have total index zero, so the surface allows a defect-free field elsewhere without checking the complete surface account.",
        ...
        "repair": "Name the surface, inspect all defects, state boundary behavior, and only then compare the total index with Euler characteristic. A repaired claim should say whether the list of defects is complete and whether each local index belongs to the same surface.",
        "concepts": ["poincare-hopf", "vector-field-index", "euler-characteristic"],
    },
    {
        "title": "Modeling motion with missing forbidden states",
        "tempting_claim": "A path exists in the drawn state diagram, so the physical system can move that way even before forbidden states are removed.",
    ...
    },
    {
        ...
        "tempting_claim": "The Euler characteristic changed after redrawing the cells, so the surface number itself changed rather than the cell account being wrong.",
        ...
        "repair": "Check the surface first, then check vertices, edges, and faces. The count is evidence only when the cell account still describes the same object. A repaired explanation should say which cells were refined and which surface data stayed fixed.",
        "concepts": ["euler-characteristic", "triangulation", "manifold"],
    },
    {
        "title": "Reading a source as stronger than it is",
        "tempting_claim": "The reference is listed, so it proves the exact sentence on the lecture page, including wording the lecture evidence may not support.",
        ...
        "repair": "Name the sentence, name the source evidence, and weaken the sentence if the evidence supports only a background family or course-arc inference. A repaired claim should say exactly what the source supports and what stronger wording remains unsaid.",
        "concepts": ["topology-vs-geometry", "poincare-hopf", "invariant"],
    },
    {
        "title": "Treating a theorem as a procedure",
        "tempting_claim": "The theorem proves existence, so it also tells us how to find the object or path and compute the missing details.",
        ...
        "repair": "State the conclusion type: existence, obstruction, equality, parity, or count. Then say what stronger conclusion remains unproved. A repaired theorem sentence should make the limited payoff visible before the reader expects a recipe.",
