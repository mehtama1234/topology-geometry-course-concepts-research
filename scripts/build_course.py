...
TERM_TRANSLATIONS = [
    {
        ...
        "failure_if_misread": "If topology is read as loose shape talk, the proof loses its rulebook. A reader may bend, cross, or erase a feature that the original problem required them to keep.",
        "concepts": ["topology-vs-geometry", "deformation", "invariant"],
        "reader_question": "What exact detail is topology keeping alive after the drawing has been changed, and which move would destroy that detail?",
    },
    {
        "term": "Geometry",
        "everyday_sentence": "Geometry keeps measured information in view: length, angle, area, curvature, direction, and local bending at the place being inspected.",
        ...
        "reader_question": "Which measured local fact is being kept, where is it measured, and what whole-shape claim will it support?",
    },
    {
        "term": "Invariant",
        "everyday_sentence": "An invariant is a fact chosen because it stays the same while the allowed changes in this problem are made.",
        ...
        "reader_question": "Which allowed move has been checked, what local event threatens the fact, and why does this fact survive that move?",
    },
    {
        "term": "Deformation",
        ...
        "reader_question": "What is allowed to move, what must stay fixed during the motion, and what would count as changing the problem instead of solving it?",
    },
    {
        "term": "Quotient space",
        ...
        "reader_question": "Which points have been declared identical, what route or boundary changes because of that declaration, and what flat-picture feature is no longer literal?",
    },
    {
        "term": "Product space",
        ...
        "reader_question": "What are the separate choices, does one point in the product really describe one complete state, and which later restriction cuts that product down?",
    },
    {
        "term": "Manifold",
        ...
        "reader_question": "What works in each small patch, what still has to be checked around the whole shape, and which full trip could reveal failure?",
    },
    {
        ...
        "reader_question": "Which coincidence was removed, what count or sign rule became readable afterward, and why did the small move preserve the question?",
    },
    {
        "term": "Orientation",
        ...
        "reader_question": "Where does the sign convention come from, can it be carried consistently through the space being used, and where would it fail?",
    },
    {
        ...
        "reader_question": "What surface is being counted, which cells changed during the redraw, and why does changing the breakup leave the alternating account fixed?",
    },
    {
        "term": "Parity",
        ...
        "reader_question": "Why do the allowed changes affect the count in pairs, and what desired zero-count conclusion does oddness block?",
    },
    {
        ...
        "reader_question": "What gives each meeting its sign, what legal motion could create a canceling pair, and why does the signed total survive?",
    },
    {
        "term": "Fixed point",
        ...
        "reader_question": "What is the space, what is the rule, where do outputs land, and why can the rule not move every point away from itself?",
    },
    {
        "term": "Configuration space",
        "everyday_sentence": "A configuration space is the shape made by listing every allowed state of a system after forbidden states are removed.",
        ...
        "reader_question": "What data describe one complete state, which states have been removed as forbidden, and how does a path become a real motion?",
    },
    {
        ...
        "concepts": ["vector-field-index", "equilibrium", "poincare-hopf"],
        "reader_question": "What loop surrounds the defect, how do the arrows turn during one trip around it, and what would make the defect account invalid?",
    },
    {
        ...
        "reader_question": "What are all the defects, what is their signed total, what surface number must that total match, and what conclusion is not being computed?",
    },
]
